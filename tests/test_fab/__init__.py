...
C2 = fab.Card(
    ...
    image_urls   = {'1HP114 - N': 'https://storage.googleapis.com/fabmaster/media/images/1HP114.width-450.png', 'WTR093 - A': 'https://storage.googleapis.com/fabmaster/media/images/WTR_93.width-450.png', 'WTR093 - U': 'https://storage.googleapis.com/fabmaster/media/images/U-WTR93.width-450.png'},
    intelligence = None,
    keywords     = [],
    name         = 'Flic Flak',
    pitch        = 2,
...
C3 = fab.Card(
    ...
    image_urls   = {'HER037 - N': 'https://storage.googleapis.com/fabmaster/media/images/HER037.width-450.png', 'CHN001 - N': 'https://storage.googleapis.com/fabmaster/media/images/CHN001.width-450.png', 'MON154 - F': 'https://storage.googleapis.com/fabmaster/media/images/MON154.width-450.png', 'MON154 - U': 'https://storage.googleapis.com/fabmaster/media/images/U-MON154.width-450.png'},
    intelligence = 4,
    keywords     = ['Go again'],
    name         = 'Chane',
    pitch        = None,
